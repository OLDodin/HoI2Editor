...
namespace HoI2Editor.Models
{
    ...
    public static class Misc
    {
        ...
        {
            {true,true,true,true,true,true,true,true,true,true}, // Economy
            {false,false,false,false,false,false,true,true,true,true}, // Intelligence
            {false,false,false,false,false,false,true,true,true,true}, // Diplomatic
            {true,true,true,true,true,true,true,true,true,true}, // fight
            {false,false,false,false,false,false,true,true,true,true}, // mission
            {false,false,false,false,false,false,true,true,true,true}, // Nation
            {true,true,true,true,true,true,true,true,true,true}, // the study
            {false,false,false,false,false,false,true,true,true,true}, // Trade
            {false,false,false,false,false,false,true,true,true,true}, // AI
            {false,false,false,false,false,false,true,true,true,true}, // MOD
            {false,false,false,false,false,false,true,true,true,true}, // map
        };
        ...
        public static MiscItemId[][] SectionItems =
        {
            new[]
            {
                ...
                MiscItemId.TrickleBackFactorManpowerFromAirLosses,
                MiscItemId.TrickleBackFactorManpowerFromSeaLosses,
        ...
        public static Dictionary<MiscItemId, double> DblMinValues = new Dictionary<MiscItemId, double>
        {
            ...
            { MiscItemId.TrickleBackFactorManpowerFromAirLosses, 0 },
            { MiscItemId.TrickleBackFactorManpowerFromSeaLosses, 0 }
        };
        ...
        public static Dictionary<MiscItemId, double> DblMaxValues = new Dictionary<MiscItemId, double>
        {
            ...
            { MiscItemId.TrickleBackFactorManpowerFromAirLosses, 1 },
            { MiscItemId.TrickleBackFactorManpowerFromSeaLosses, 1 }
        };
        ...
        public static readonly string[] ItemNames =
        {
            ...
            "CvMaxAttach",
            "CanChangeIdeas",
            "TrickleBackFactorManpowerFromAirLosses",
            "TrickleBackFactorManpowerFromSeaLosses",
        ...
        public static MiscGameType GetGameType()
        {
            switch (Game.Type)
            {
                ...
                case GameType.ArsenalOfDemocracy:
                    if (Game.Version >= 111)
                    {
                        return MiscGameType.Aod111;
                    }
                    else if (Game.Version >= 108)
                    {
                        return MiscGameType.Aod108;
                    }
                    else if (Game.Version <= 104)
                    {
                        return MiscGameType.Aod104;
                    }
                    else
                    {
                        return MiscGameType.Aod107;
                    }
    ...
    public enum MiscItemId
    {
        ...
        TrickleBackFactorManpowerFromAirLosses, // Trickle-back factor for manpower from air losses. (ie, ground troops freed)
        TrickleBackFactorManpowerFromSeaLosses, // Trickle-back factor for manpower from sea losses. (ie, people who didnt drown)
